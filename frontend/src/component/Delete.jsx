    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-xl shadow-lg text-center max-w-sm w-full">
        <h2 className="text-xl font-semibold mb-4 text-gray-800">
          𓇢𓆸 Delete Confirmation Are you sure you want to delete this item?
        </h2>
        <div className="flex justify-around mt-6">
          <button
            onClick={onClose}
            className="w-28 bg-black drop-shadow-lg hover:bg-[#6499E9] font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center  me-2 mb-2 text-gray-50"
          >
            <svg
